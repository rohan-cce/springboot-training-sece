...
// @Service // <-- TUTOR SABOTAGE: Keep this commented out! Watch the app violently crash on startup with a 'Missing Bean' error, forcing students to read stack traces! Uncomment on stage to fix.
